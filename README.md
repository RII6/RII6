...
Я студент Университета Иннополис (направление «Инженерия Информационных Систем»). Специализируюсь на построении отказоустойчивой инфраструктуры, безопасных пайплайнов CI/CD и автоматизации проверок уязвимостей. Совмещаю сильную фундаментальную базу в Computer Science, успешный олимпиадый опыт с практическим опытом инженерного лидерства.

## 🎯 Мой фокус
- **Site Reliability Engineering (SRE):** проектирую самовосстанавливающуюся (self-healing) и автомасштабируемую инфраструктуру. Внедряю практики Observability (Prometheus, Grafana), RED-метрики и Chaos Engineering.
...
- **Минимизация рисков & AI Security:** разрабатываю надежные решения, включая модули для тестирования безопасности ИИ (атаки моделей через обфускацию вредоносных промптов).
